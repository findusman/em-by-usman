...
export { default as clearLatestShortcuts } from './clearLatestShortcuts'
...
export { default as dragShortcut } from './dragShortcut'
export { default as dragShortcutZone } from './dragShortcutZone'
...
export { default as toggleShortcutsDiagram } from './toggleShortcutsDiagram'
